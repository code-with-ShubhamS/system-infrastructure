          ...
          <div className='flex flex-col gap-12'>
            <div className='flex flex-col justify-center items-center gap-10 lg:gap-16'>
              <motion.div
                ...
                <h2>
                  Master the 5 fundamental areas of
                  <span className='instrument-font italic font-normal dark:text-white/70'>
                    {' '}UX/UI design
                  </span>
                </h2>
                <p className='text-dark_black/60 dark:text-white/60 mt-4'>
                  Each area includes case studies, recommended tools, and 
                  practical resources to apply in real projects.
                </p>
              </motion.div>
              <motion.div
                {...bottomAnimation(2)}
            ...
            <motion.div
              ...
              <div className='text-center xl:text-left'>
                <h4 className='text-white mb-2'>
                  Ready to dive deeper into UX/UI?
                </h4>
                <p className='text-white/70'>
                  Explore our detailed case studies and practical resources
                </p>
              </div>
