          ...
          <div ref={ref} className='flex flex-col gap-8'>
            <motion.div
              ...
              <p className='max-w-38 text-dark_black/60 dark:text-white/60'>
                An educational website dedicated to user experience and interface design. 
                Explore real case studies, discover professional tools, and access 
                curated resources for students and digital design professionals.
              </p>
            </motion.div>
                ...
                <div className='flex items-center gap-7'>
                  ...
                  <div className='gap-1 flex flex-col'>
                    ...
                    <p className='text-sm font-normal text-dark_black/60 dark:text-white/60'>
                      Academic project, Universidad Galileo
                    </p>
                  </div>
                </div>
              </div>
