...
```
  (1) When using pm2 start npm -- run <script>
-> PM2 manages the npm process, not the actual Node.js app.
-> If the Node.js app inside npm crashes, PM2 may not detect or restart it properly.
-> Not recommended for production.

(2)  When using pm2 start app.js (or pm2 start node app.js)
-> PM2 directly manages the Node.js process.
-> If it crashes or stops, PM2 automatically restarts it.
