...
### Configure MongoDB Authentication ( Not Recommnended because the port is publicaly available and hacker can enter using this port)
...
MongoDB URI to Connect with projects:
Note => If your password contain some speacial character than first you need to encode it as URL.
```bash
